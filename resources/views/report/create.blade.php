    ...
    <div class="col-12 col-xl-12">
        <div class="card">
            <div class="card-header">
                <h4>Investigation Report for {{ $id }}</h4>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-xl-12">
                        <div class="form-group">
                            <label for="emp_material">Root Cause(s) and Recommendation of Incident/injury:  <span class="text-danger"> *</span></label>
                    ...
                    <div class="col-4 col-xl-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="dateTimeFlatpickr2" class="form-control" value="{{ old('safety') }}" name="safety" placeholder="Safety Awareness Training Date">
                            </div>
                    </div>
                    <div class="col-8 col-xl-8">
                        <div class="form-group">
                    ...
                    <div class="col-6 col-xl-6">
                        <div class="form-group custom-file-container" data-upload-id="mySecondImage">
                            ...
                            <label class="custom-file-container__custom-file" >
                                <input type="file" class=" form-control" name="inc_img[]"  multiple>
                                <span class="custom-file-container__custom-file__custom-file-control"></span>
                            </label>
                            <div class="custom-file-container__image-preview"></div>
                        </div>
