...
<head>
    ...
    <title>HSE - Error 500 Page</title>
    ...
    <link href="/admin/assets/css/pages/error/style-500.css" rel="stylesheet" type="text/css" />
...
<body class="error500 text-center">
        ...
        <div class="row">
            <div class="col-md-4 mr-auto mt-5 text-md-left text-center">
                <a href="index-2.html" class="ml-md-5">
                    <img alt="image-500" src="/admin/assets/img/logo2.svg" class="theme-logo">
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid error-content">
        <div class="">
            ...
            <a href="/dashboard" class="btn btn-secondary mt-5">Go Back</a>
        </div>
    </div>
