                        ...
                        <tr>
                            <th>ID</th>
                                    ...
                                    <tr>
                                        ...
                                        <a role="button" href="{{ route('locations.edit', $location->id) }}">
                                        ...
                                        <a href="" role="button" data-toggle="modal" data-target="#delete{{$location->id}}">
...
@foreach ($locations as $location)
        <!-- Delete -->
        <div class="modal fade" id="delete{{ $location->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleStandardModalLabel" aria-hidden="true">
