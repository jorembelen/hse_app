...
<div class="row">
    ...
    <div class="col-12 col-xl-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" method="POST" action="{{ route('incidents.update', $incidents->id) }}" enctype="multipart/form-data" id="inc-Update">
                    @csrf
                    {{ method_field('PUT') }}
                    ...
                    <div class="form-group">
                        ...
                        <select name="location" class="form-control select2">
                            @if (auth()->user()->role == 'admin' || auth()->user()->role == 'super_admin')
                                <option value="{{ $incidents->location }}">{{ $incidents->locations->name }} - {{ $incidents->locations->loc_name }}</option>
                                @foreach( $locations as $location)
                                <option value="{{$location->id}}" @if (old('location') == $location->id ) selected="selected" @endif>{{$location->name}} - {{$location->loc_name}}</option>
                                @endforeach
                            @else
                                <option value="{{ auth()->user()->location_id }}">{{ auth()->user()->locations->name }} - {{ auth()->user()->locations->loc_name }}</option>   
                            @endif
                                </select>
                    </div>
                </div>
                ...
                <div class="col-4 col-xl-4">
                    <div class="form-group">
                        ...
                        <select name="inc_category" class="form-control select2" >
                ...
                <div class="col-4 col-xl-4">
                    <div class="form-group">
                        ...
                        <select name="insurance" class="form-control select2" >
                ...
                <div class="col-2 col-xl-2">
                    <div class="form-group">
                        ...
                        <select name="sel_involved" class="form-control select2" id="frst_aid" >
                ...
                <div class="col-5 col-xl-5">
                    <div class="form-group frm-aider-div" id="vidEmployee" style="display:none">
                        ...
                        <select name="employee[]" class="form-control select2" multiple>
                ...
                <div class="col-6 col-xl-6">
                    <div class="form-group">
                    <label for="injury_location">Injury Location (Select one or more if necessary):<span class="text-danger"> {{ $incidents->injury_location }} </span></label>
                    <select name="injury_location[]" class="form-control select2" multiple>
                        <option value="{{ $incidents->injury_location }}">{{ $incidents->injury_location }}</option>
            ...
            <div class="col-6 col-xl-6">
                <div class="form-group">
                    <label for="injury_sustain">Type of Injury Sustained (Select one or more if necessary):<span class="text-danger"> {{ $incidents->injury_sustain }}</span></label>
                    <select name="injury_sustain[]" class="form-control select2" multiple>
            ...
            <div class="col-6 col-xl-6">
                <div class="form-group">
                    ...
                    <select name="cause[]" class="form-control select2" multiple>
        ...
        <div class="col-6 col-xl-6">
            <div class="form-group">
                ...
                <select name="equipment[]"  class="form-control select2" multiple>
    ...
    <div class="col-6 col-xl-6">
        <div class="form-group">
            ...
            <textarea class="form-control" name="description" id="field-7" placeholder="Write your description here ..." >{{ $incidents->description }}</textarea> 
        </div>
    </div>
    <div class="col-6 col-xl-6">
        <div class="form-group">
            <label for="action">Immediate Action(s) Taken to Prevent Reoccurance (If any)<span class="text-danger"> *</span></label>
            <textarea class="form-control" name="action" placeholder="Write your immediate action here ..." >{{ $incidents->action }}</textarea>
            </div>
    </div>
    <div class="col-4 col-xl-4">
        <div class="form-group">
            <label for="wps">WPS<span class="text-danger"> *</span></label>
            <select name="wps" class="form-control select2" >
    ...
    <div class="col-4 col-xl-4">
        <div class="form-group">
            ...
            <select name="severity" class="form-control select2"  >
    ...
    <div class="col-4 col-xl-4">
        <div class="form-group">
            ...
            <input type="text" value="{{ $incidents->date }}" id="dateTimeFlatpickr" name="date" class="form-control flatpickr flatpickr-input active" placeholder="Select Date and Time..">
        </div>
    </div>
    <div class="col-9 col-xl-9">
        <div class="form-group custom-file-container" data-upload-id="mySecondImage">
            <label>Incident Images (Attach image) <a href="#" class="custom-file-container__image-clear" title="Clear Image">x</a> <span class="text-danger"> {{ $incidents->images }} </span></label>
