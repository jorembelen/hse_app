...
<div class="row">
    ...
    <div class="col-12 col-xl-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal form-disabled-button" method="POST" action="{{ route('incidents.store') }}" enctype="multipart/form-data" id="inc-Create">
                    @csrf
    ...
    <div class="col-4 col-xl-4">
        <div class="form-group">
            ...
            <input type="text" value="{{ old('date') }}" id="dateTimeFlatpickr" name="date" class="form-control flatpickr flatpickr-input active" placeholder="Select Date and Time..">
        </div>
    </div>
