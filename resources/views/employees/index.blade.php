...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="row ml-2">
                <div class="col-md-5">
                    <form class="mt-0" action="{{url('/admin/search')}}" method="POST">
                        @csrf
            ...
            <div class="card-body">
                <table id="table" class="table table-striped dataTable no-footer dtr-inline" style="width: 100%;" role="grid" aria-describedby="datatables-reponsive_info">
                    <thead>
                        <tr>
                                <th>ID</th>
                                <th>Badge</th>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="" role="button" data-toggle="modal" data-target="#delete{{$employee->id}}">
